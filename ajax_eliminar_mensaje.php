<?php
	...
	/* Script PHP que procesa la petición AJaX para la eliminación de mensajes privados */
	...
	$mensaje->establecer("id_mensaje", $_POST["id_mensaje"]); //Caracterización del objeto para que pueda marcar como eliminado el mensaje en la BD
