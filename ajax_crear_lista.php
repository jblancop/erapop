<?php
	...
	/* Script PHP que procesa la petición AJaX para la creación de un recopilatorio personalizado */
	...
	$lista->establecer("nombre_lista", $nombre_lista); //Caracterización del objeto para que pueda crear la lista en la BD
	$lista->establecer("descripcion", $descripcion);
	$lista->establecer("id_usuario", $_SESSION['id_usuario']);
	
	$resultado = $lista->crear();
